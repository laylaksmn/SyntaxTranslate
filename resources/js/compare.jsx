            ...
            <div className="flex flex-1 gap-6 relative">
                ...
                <main className="flex-1 flex flex-col pb-8 min-w-0">
                    <div className="flex justify-between items-center mb-8 mt-2">
                        <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">COMPARE</h1>
                        <button 
                    ...
                    {!showDiff ? (
                        <div className="flex flex-1 gap-6">
                            ...
                            <div className="flex-1 bg-white rounded-[2rem] p-2 flex flex-col border border-slate-200/60 shadow-sm overflow-hidden min-h-[500px]">
                                <div className="flex justify-between items-center mb-2 px-4 py-3 border-b border-slate-100">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button onClick={() => setFirstCode("")} className="text-slate-400 hover:text-slate-800 transition-colors cursor-pointer">
                                            <X size={16} />
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div className="flex-1 bg-white rounded-[2rem] p-2 flex flex-col border border-slate-200/60 shadow-sm overflow-hidden min-h-[500px]">
                                <div className="flex justify-between items-center mb-2 px-4 py-3 border-b border-slate-100">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <span className="text-[10px] font-bold text-slate-500 border border-slate-200 rounded-full px-3 py-1">TYPESCRIPT</span>
                                        <button onClick={() => handleCopy(secondCode)} className="text-slate-400 hover:text-slate-800 transition-colors cursor-pointer">
                                            <Copy size={16} />
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className="flex-1 bg-white rounded-[2rem] p-2 flex flex-col border border-slate-200/60 shadow-sm overflow-hidden min-h-[500px]">
                            <div className="flex justify-between items-center mb-2 px-4 py-3 border-b border-slate-100">
                                <span className="text-[13px] font-bold text-slate-800">CODE_DIFFERENCE</span>
                                <div className="flex items-center gap-3">
                                    <span className="text-[10px] font-bold text-slate-500 border border-slate-200 rounded-full px-3 py-1">COMPARISON</span>
                                    <button onClick={() => setShowDiff(false)} className="text-slate-400 hover:text-slate-800 transition-colors cursor-pointer" title="Back to Editor">
                                        <X size={16} />
                                    </button>
                                </div>
                            </div>
